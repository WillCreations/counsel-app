        ...
        <div class="container-fluid">
                        ...
                        <div class="modal-body">
                            <form action="counselor_process.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger"> <?php echo isset($errFname) ? $errFname : null; ?>
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger"> <?php echo isset($errUsername) ? $errUsername : null; ?>
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger"> <?php echo isset($errEmail) ? $errEmail : null; ?>
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger"> <?php echo isset($errPhone) ? $errPhone : null; ?>
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger"> <?php echo isset($errAddress) ? $errAddress : null; ?>
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger"> <?php echo isset($errCpass) ? $errCpass : null; ?>
                                    </span>
                                </div>
            ...
            <div class="row">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Counselor Colleagues</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php echo htmlspecialchars($csum); ?>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                ...
                try {
                    ...
                    $apptQuery = "SELECT * FROM appointment WHERE appointment_status = ? AND counselor_id = (SELECT id FROM counselor WHERE userid = ? LIMIT 1)";
                    $stmtAppt = $conn->prepare($apptQuery);
                    $stmtAppt->execute(['pending', $_SESSION['userid']]);
                    $apptCount = (int) count($stmtAppt->fetchALL(PDO::FETCH_ASSOC));

                } catch (PDOException $e) {
                    error_log('PDO Error in counselor.php: ' . $e->getMessage());
                    $apptCount = 0;
                }
                ?>
                <div class="col-xl-3 col-md-6 mb-4">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php echo htmlspecialchars($apptCount); ?>
                                    </div>
                                </div>
                                <div class="col-auto">
