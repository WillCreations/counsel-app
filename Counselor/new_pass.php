        ...
        <div class="col-lg-6 m-auto">
            <div class="card bg-dark" style="margin-top: 200px;">
                <div class="card-title bg-light text-white mt-5">
                    <h2 class="text-center text-dark">Create New Password</h2>
                    <?php if(isset($_SESSION['error'])): ?>
                        <div class="alert alert-danger"><?php echo $_SESSION['error']; ?></div>
                        <?php unset($_SESSION['error']); ?>
                    <?php endif; ?>
                    <form action="new-pass-process.php" method="post">
                    ...
                    <div class="text-center mt-3">
                        <a href="login.php" class="text-warning"><i class="fa fa-arrow-right"></i> Back to Login</a>
                    </div>
                </div>
            </div>
        </div>
