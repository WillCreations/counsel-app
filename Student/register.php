...
<div class="container mt-5" style="width: 600px;">
    ...
    <form action="register_process.php" method="post" class="mt-5" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <textarea name="career_asp" cols="30" placeholder="Career Aspiration" class="form-control"></textarea>
        </div>
        ...
        <div class="form-group m-b-0">
            <div class="col-sm-12 text-center text-dark">
                Already have an account? <a href="../index.php" class="text-dark m-l-5"><b>Sign In</b></a>
            </div>
        </div>
    </form>
