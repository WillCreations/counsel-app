...
<body>
    ...
    <h4 class="text-center bg-dark  mb-4 p-4">Welcome To Lanre Awolokun High School Computerized Career Guidance Information System Gbagada</h4>
        ...
        <div class="border p-4 maxRadius bg-dark ">
          <form action="./Student/login_process.php" method="post">
            ...
            <div class="form-group">
              <input type="text" class="form-control" id="username" name="user" placeholder="Enter username or Email">
            </div>
            <div class="form-group">
            ...
            <div class="text-center mt-3">
                <a href="./Student/change-pass.php" class="text-danger"><i class="fa fa-exclamation-triangle"></i> Forgotten Password?</a>
            </div>
          </form>
  ...
  <div class="container mt-5 row justify-content-center">
    ...
    <div class="col-md-6">
      <h4 class="text-warning  text-center"> <a href="./Student/register.php" class="btn-center btn btn-warning ">Sign-Up as a Student</a></h4>
    </div>

    <div class="col-md-6">
      <h4 class="text-primary text-center "><a href="./Counselor/login.php" class="btn-center btn btn-warning">Sign-In as a Counselor</a></h4>
    </div>
